...
- [x] Формирование отчёта в формате CSV о проведенных транзакциях из LocaleStorage
- [x] Формирование отчёта в формате CSV о транзакциях отображаемых на странице 
